...
class HomeBackgroundDecoration extends StatelessWidget {
  const HomeBackgroundDecoration({super.key});

  @override
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: Positioned.fill(
        bottom: 110, // ✅ مهم: لا تلمس منطقة الـ bottom bar
        child: Stack(
          children: [
            // تدرّج خفيف جداً لأسفل الصفحة (يعبي الفراغ)
            Positioned.fill(
              child: DecoratedBox(
            ...
            // لمسة داخل الهيدر (خفيفة)
            Positioned(
              left: -140,
              top: -110,
              child: _blob(270, Colors.white.o(0.08)),
            ),

            // قوس كبير أسفل يسار (واضح)
            Positioned(
              left: -190,
              bottom: -120,
              child: _arc(
            ...
            // Blob خفيف جداً بالمنتصف تحت الكروت
            Align(
              alignment: const Alignment(0.0, 0.42),
              child: _blob(320, AppColors.lightGreen.o(0.025)),
            ),
