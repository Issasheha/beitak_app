...
class ProviderRatingSheet extends ConsumerStatefulWidget {
  final int bookingId;
  final String serviceTitle;
  final String customerName;

  const ProviderRatingSheet({
    super.key,
  ...
  @override
  ConsumerState<ProviderRatingSheet> createState() => _ProviderRatingSheetState();
}

class _ProviderRatingSheetState extends ConsumerState<ProviderRatingSheet> {
  int rating = 0;
  ...
  void initState() {
    ...
    _msgFocus.addListener(() {
      if (_msgFocus.hasFocus) _ensureVisible(_msgKey);
    });
    ...
    try {
      await ref
          ...
          .submitProviderRating(
            ...
            amountPaid: amount,
            providerResponse: msgCtrl.text.trim(),
          );
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                maxLines: 3,
                                decoration: _inputDeco(hint: 'مثال: شكراً الك، سعدنا بخدمتك…'),
                              ),
                            ),
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: _inputDeco(hint: 'مثال: 25.0'),
                              ),
                            ),
