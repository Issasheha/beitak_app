class ApiConstants {
  static const String baseUrl ='https://ensuring-era-believes-prison.trycloudflare.com';
...
static const String providerDeactivate = '/providers/deactivate';
  ...
  static String providerRatings(int providerId) => '/ratings/provider/$providerId';
  ...
  static String availableDays(int providerId) => '/bookings/available-days/$providerId';
